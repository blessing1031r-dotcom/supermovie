...
def main():
    ...
    if not isinstance(config, dict):
        ...
        return emit_json("config_invalid", 3, error=msg)
    ...
    except (urllib.error.URLError, OSError, UnicodeDecodeError, json.JSONDecodeError) as e:  # PR-PM step 519: decode/json.loads on API response
