...
main
 ...
 └─ roku/exit-code-entry-audit (HEAD)
...
## 全 commit count (roku/exit-code-entry-audit branch、最新 142 件)

```
e4b1a7a feat(observability): entry exit code propagation audit (PR-P、Codex 01:21 approve)
...
(更新: 2026-05-06_01:25、source=HEAD、`scripts/regen_phase3_progress.sh` で auto-gen。
