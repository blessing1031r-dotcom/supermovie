...
| 項目 | 値 (Bash 実測 2026-05-05 21:59) |
|---|---|
| HEAD (source commit) | `b862281` (PR-D rate env v0 → v1 alias、anchor 自身の document commit はこの後ろに 1 件積まれる、§Source commit vs Document commit 規約 参照) |
...
| 7 gate composite | ALL PASS at b862281 (env / worktree clean / regen drift 1 / **52/52 python smoke (43 既存 + 9 obs)** / lint exit 0 / React 22/22 / **gate 7 anchor drift = 1 intrinsic OK**、Bash 実測 21:59) |
