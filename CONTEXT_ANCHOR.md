...
| 項目 | 値 (Bash 実測 2026-05-05 20:51) |
|---|---|
| HEAD (source commit) | `a9f7978` (Codex 20:48 PR3 review P1+P2 fix iter 適用済、anchor 自身の document commit はこの後ろに 1 件積まれる、§Source commit vs Document commit 規約 参照) |
| branch | `roku/obs-migration-core` (`fork/main=4565ebb` 起点、Codex 1 review iter 適用済) |
...
| 7 gate composite | ALL PASS at a9f7978 (env / worktree clean / regen drift 1 / **50/50 python smoke (43 既存 + 7 新規 observability)** / lint exit 0 / React 22/22 / **gate 7 anchor drift = 1 intrinsic OK**、Bash 実測 20:51) |
