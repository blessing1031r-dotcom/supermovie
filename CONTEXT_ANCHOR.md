...
|---|---|
| HEAD (source commit) | `44b30be` (PR-G feat: 3 script error path tail emit audit + 9 status + 4 件 regression test + docs Migration step 8) |
...
| 7 gate composite | ALL PASS at 44b30be (env / worktree clean / regen drift 1 / **66/66 python smoke (62 PR-F までの累積 + 4 PR-G)** / lint exit 0 / React 22/22 / **gate 7 anchor drift = 1 intrinsic OK**、Bash 実測 23:23) |
